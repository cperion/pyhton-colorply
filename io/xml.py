...
@author: Cédric Perion | Arthur Dujardin    #GROUPE C
"""
...
def readCalib(calibxml):
    ...
    Example : "AutoCal_Foc-24000_Cam-DSLRA850.xml"
    @paramtype calibxml : string
    :return : F, PPS, distorsion coefficients a, b, c
    :rtype : tuple(F, PPS, [a,b,c])
    """
